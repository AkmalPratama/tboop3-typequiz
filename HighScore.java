...
public class HighScore {
  ...
  public void printToTxt() throws IOException {
    String text;
    String text2;
    BufferedWriter output = new BufferedWriter(new FileWriter("src/model/highscore.txt")) ;
    BufferedWriter output2 = new BufferedWriter(new FileWriter("src/model/highscoreshow.txt")) ;
    if (tail != -1) {
      for (int i = 0; i <= tail; i++) {
